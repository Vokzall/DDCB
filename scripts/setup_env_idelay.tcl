# =============================================
# Project Configuration — IDELAYE3 wrapper synthesis
# =============================================

set design(DESIGN)          "IDELAYE3"
...
set design(VERILOG_FILES) [list \
    "${design(VERILOG_DIR)}/IDELAYE3.sv" \
]
...
# SDC File
set design(SDC_FILE) "${design(SDC_PATH)}/IDELAYE3.sdc"
